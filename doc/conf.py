# -*- coding: utf-8 -*-
#
# SpenDB documentation build configuration file, created by
...
project = u'SpenDB'
project_short_name = u'SpenDB'
copyright = '&copy; 2009-2014, Open Knowledge Foundation, 2015, Map The Money'
...
import spendb
version = spendb.__version__.rstrip('abcdefgh')
...
latex_documents = [
  ('index', 'SpenDB.tex', u'SpenDB Documentation',
...
edit_on_github_project = 'spendb/spendb'
