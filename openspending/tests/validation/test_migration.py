...
class TestMigration(TestCase):
    ...
    def test_2011_11_20_require_name_attribute(self):
        model = validation_fixture('2011_11_20_name_attribute')
    ...
    def test_2011_11_21_normalize_types(self):
        model = validation_fixture('2011_11_21_normalize')
    ...
    def test_2011_11_22_unique_keys(self):
        model = validation_fixture('2011_11_22_unique_keys')
    ...
    def test_2011_12_07_attribute_dicts(self):
        model = validation_fixture('2011_12_07_attribute_dicts')
